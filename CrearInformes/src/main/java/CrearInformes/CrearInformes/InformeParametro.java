...
public class InformeParametro extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InformeParametro frame = new InformeParametro();
	 ...
	 */
	public InformeParametro() throws SQLException, ClassNotFoundException {
	...
	public void crearInforme()
		...
		try {
			...
			report = (JasperReport) JRLoader.loadObject(InformeParametro.class.getResource(path));
			
			//subReport = (JasperReport) JRLoader.loadObjectFromFile(pathSub);
			
			subReport = (JasperReport) JRLoader.loadObject(InformeParametro.class.getResource(pathSub));
